...
/**
 * This class reflects the `qe` comparison operator as `greater or equal` on
 * Doctrine ORM Expr
 *
 * @author Igor Timoshenko <igor.timoshenko@i.ua>
 */
class GeRuleReflection extends AbstractRuleReflection
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        return $this->queryBuilder->expr()->gte(
            $rule->getField(),
